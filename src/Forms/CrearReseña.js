...
export default function CrearResenia(props) {
    ...
    const submit = (e) => {
        ...
        if(id === "0"){
            ...
            axios.post(process.env.REACT_APP_ENDPOINT+"/resenias", entity).then(res => {
            ...
            axios.put(process.env.REACT_APP_ENDPOINT+"/resenias", entity).then(res => {
    ...
    useEffect(() => {
        if(id !== "0"){
            handleLoader(true)
            axios.get(process.env.REACT_APP_ENDPOINT+"/resenias/"+id).then(res => {
