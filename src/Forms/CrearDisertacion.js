...
export default function CrearDisertacion(props) {
    ...
    const submit = (e) => {
        ...
        if(id === "0"){
            ...
            axios.post(process.env.REACT_APP_ENDPOINT+"/disertacions", entity).then(res => {
            ...
            axios.put(process.env.REACT_APP_ENDPOINT+"/disertacions", entity).then(res => {
    ...
    useEffect(() => {
        if(id !== "0"){
            handleLoader(true)
            axios.get(process.env.REACT_APP_ENDPOINT+"/disertacions/"+id).then(res => {
